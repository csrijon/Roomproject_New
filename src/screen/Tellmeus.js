...
const Tellmeus = ({ navigation }) => {
    ...
    const [selectdollar, setSelectdollar] = useState(0);
        ...
        <SafeAreaView style={styles.mainsection}>
            ...
            >
                ...
                <View style={styles.budget}>
                    ...
                    <Text style={styles.price}>${selectdollar}</Text>
                    ...
                    <View style={styles.seekbarsection}>
                        ...
                        <Slider
                            ...
                            minimumValue={0}
                            value={selectdollar}
                            onValueChange={(value) => setSelectdollar(value)}
                            maximumValue={5000}
                            maximumTrackTintColor="#ddd"
                            minimumTrackTintColor="#00C29B"
                            thumbTintColor="#00C29B"
                        />
                    </View>
                </View>
